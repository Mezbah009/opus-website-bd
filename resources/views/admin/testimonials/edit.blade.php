                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="name" value="{{ $testimonials->name }}">
                                    <p class="error"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="designation" id="designation" class="form-control"
                                        placeholder="Designation" value="{{ $testimonials->designation }}">
                                    <p class="error"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="Description">{{ $testimonials->description }}</textarea>
                                    <p class="error"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                @if (!@empty($testimonials->logo))
                                    <div>
                                        <img width="250" src="{{ asset('uploads/first_section/' . $testimonials->logo) }}"
                                            alt="">
                                    </div>
                                @endif
                            </div>
