...
<section id="about" class="about">
    <div class="container" data-aos="fade-up" style="box-shadow: none;">
        <div class="row no-gutters">
            <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
                <div class="section-title">
                    <p>At Opus Technology, we specialize in crafting innovative and high-performance mobile applications tailored to meet the unique needs of your business. Mobile application development is the process of creating software for handheld devices such as smartphones, tablets, and other wireless devices. These applications are designed to leverage the advanced features of modern mobile devices, delivering seamless and engaging user experiences.
                        Our team of expert developers excels in building native, hybrid, and cross-platform mobile apps that are optimized for performance, scalability, and security. Whether you need a gaming app that utilizes the accelerometer of an iPhone or a business app that integrates with enterprise systems, we ensure your app is developed to perfection. </p>
                </div>
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
                <div class="section-title">
                ...
                <ul style="list-style-type: disc; padding-left: 20px; margin: 0; text-align: left;">
                            <li style="font-weight: bold; list-style-type: none; padding-left: 0;">Why Choose Opus Technology for Mobile App Development?</li>
                            <li style="padding-left: 10px;">Custom Solutions: We create apps tailored to your specific requirements, ensuring they align with your business goals.
                            </li>
                            <li style="padding-left: 10px;">Native Development: For apps that demand high performance, we develop natively, writing code optimized for the specific hardware and operating system of the device.
                            </li>
                            <li style="padding-left: 10px;">Cross-Platform Expertise: When your app needs to run on multiple platforms, we utilize advanced frameworks to maximize code reusability without compromising on quality.
                            </li>
                            <li style="padding-left: 10px;">End-to-End Services: From ideation and design to development, testing, and deployment, we provide comprehensive mobile app development services.
                            </li>
                            <li style="padding-left: 10px;">Cutting-Edge Technology: We stay ahead of the curve by leveraging the latest tools, technologies, and trends in mobile app development.
                            </li>
                        </ul>
                </div>
            </div>
...
<div id="about" class="about">
    <div class="container" data-aos="fade-up" style="box-shadow: none;">
        ...
        <div class="row no-gutters">
            <div class="col-lg-12 video-box">
                <img src="{{ asset('uploads/first_section/service6.png') }}" class="img-service" alt="">
            </div>
        </div>
...
<section id="about" class="about">
    <div class="container" data-aos="fade-up" style="box-shadow: none;">
        <div class="row no-gutters">
            <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
                <div class="section-title">
                    <p>At Opus Technology, we empower businesses with cutting-edge Blockchain solutions that drive transparency, security, and efficiency. Blockchain technology is revolutionizing industries by enabling decentralized, tamper-proof, and highly secure systems for transactions, data management, and more. Whether you're looking to streamline operations, enhance trust, or innovate your business model, our Blockchain services are designed to help you achieve your goals. </p>
                    <ul style="list-style-type: disc; padding-left: 20px; margin: 0; text-align: left;">
                            <li style="font-weight: bold; list-style-type: none; padding-left: 0;">Our Blockchain Services Include:</li>
                            <li style="padding-left: 10px;">Smart Contract Development: Automate and secure your business processes with self-executing smart contracts.
                            </li>
                            <li style="padding-left: 10px;">Decentralized Applications (dApps): Build scalable and secure dApps that transform how users interact with your business.
                            </li>
                            <li style="padding-left: 10px;">Blockchain Integration: Seamlessly integrate Blockchain technology into your existing systems for enhanced efficiency and security.
                            </li>
                            <li style="padding-left: 10px;">Consulting & Strategy: Our experts guide you through the complexities of Blockchain adoption, helping you identify the best use cases for your business.
                            </li>
                        </ul>
                </div>
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
                ...
                <ul style="list-style-type: disc; padding-left: 20px; margin: 0; text-align: left;">
                            <li style="font-weight: bold; list-style-type: none; padding-left: 0;">Why Choose Opus Technology for Blockchain Solutions?</li>
                            <li style="padding-left: 10px;">Expertise: Our team of Blockchain specialists has extensive experience in developing and deploying decentralized applications (dApps), smart contracts, and custom Blockchain solutions.
                            </li>
                            <li style="padding-left: 10px;">Custom Development: We build tailored Blockchain solutions that align with your unique business needs, whether it’s for supply chain management, finance, healthcare, or any other industry.
                            </li>
                            <li style="padding-left: 10px;">Security & Transparency: Leverage the power of Blockchain to create secure, transparent, and immutable systems that build trust with your stakeholders.
                            </li>
                            <li style="padding-left: 10px;">End-to-End Services: From ideation and strategy to development, integration, and maintenance, we provide comprehensive Blockchain services to ensure your success.
                            </li>
                            <li style="padding-left: 10px;">Innovation-Driven: We stay at the forefront of Blockchain technology, utilizing platforms like Ethereum, Hyperledger, and more to deliver innovative solutions.
                            </li>
                        </ul>
                </div>
            </div>
