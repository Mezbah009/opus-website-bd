        ...
        <div class="row">      
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/1.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Financial</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/2.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Healthcare</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/3.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Education</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/4.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Transportation</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/5.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Manufacturing</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/6.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Wholesale</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/7.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Retail</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/8.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Construction</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/9.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Entertainment</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/10.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Garments</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/11.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Tourism</a></h4>
            </div>
            <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                <div class="icon"> <a href=""><img
                            src="{{ asset('front-assets/img/industrylogo/12.png') }}"
                            class="img-fluid" alt="" width="50%"> </a></div>
                <h4 class="title"><a
                        href="">Engery</a></h4>
            </div>
