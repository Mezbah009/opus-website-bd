                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="button_name" id="button_name" class="form-control">
                                        <option value="" disabled
                                            {{ old('button_name', $product->button_name) ? '' : 'selected' }}>Select Product
                                            Category</option>
                                        <option value="filter-sig"
                                            {{ old('button_name', $product->button_name) == 'filter-sig' ? 'selected' : '' }}>
                                            Enterprise Solutions</option>
                                        <option value="filter-fin"
                                            {{ old('button_name', $product->button_name) == 'filter-fin' ? 'selected' : '' }}>
                                            Fintech Solutions</option>
                                        <option value="filter-mob"
                                            {{ old('button_name', $product->button_name) == 'filter-mob' ? 'selected' : '' }}>
                                            Mobile App Solutions</option>
                                        <option value="filter-ai"
                                            {{ old('button_name', $product->button_name) == 'filter-ai' ? 'selected' : '' }}>
                                            AI Solutions</option>
                                        <option value="filter-sys"
                                            {{ old('button_name', $product->button_name) == 'filter-sys' ? 'selected' : '' }}>
                                            System Solutions</option>
                                    </select>
                                </div>
                            </div>


                            <div class="col-md-6" id="fintechDropdown"
                                style="{{ $product->button_name === 'filter-fin' ? '' : 'display: none;' }}">
                                <div class="mb-3">
                                    <label for="fin_cat">Fintech Options</label>
                                    <select name="fin_cat" id="fintechOptions" class="form-control">
                                        <option value="" disabled {{ !$product->fin_cat ? 'selected' : '' }}>Select
                                            Fintech Option</option>
                                        <option value="filter-cb"
                                            {{ $product->fin_cat === 'filter-cb' ? 'selected' : '' }}>Conventional Banking
                                        </option>
                                        <option value="filter-ib"
                                            {{ $product->fin_cat === 'filter-ib' ? 'selected' : '' }}>Islamic Banking
                                        </option>
                                        <option value="filter-mf"
                                            {{ $product->fin_cat === 'filter-mf' ? 'selected' : '' }}>Micro-Finance
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" readonly name="slug" id="slug" class="form-control"
                                        placeholder="Link" value="{{ $product->link }}">
                                    <p class="error"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @if (!@empty($product->logo))
                                    <div>
                                        <img width="250" src="{{ asset('uploads/first_section/' . $product->logo) }}"
                                            alt="">
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_keywords" id="meta_keywords" class="form-control"
                                        placeholder="e.g. fintech, banking, mobile apps"
