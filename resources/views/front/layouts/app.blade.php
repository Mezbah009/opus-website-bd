    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            <div class="logo me-auto">
                <!-- <h1><a href="index.html">OPUS</a></h1> -->
                <!-- Uncomment below if you prefer to use an image logo -->
                <a href="{{ route('front.home') }}"><img src="{{ asset('front-assets/img/opus-logo.png') }}" alt="" class="img-fluid"></a>
            </div>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto {{ Request::is('services') ? 'active' : '' }}" href="{{ route('front.services') }}">Services</a></li>
                    <li><a class="nav-link scrollto {{ Request::is('blogs') ? 'active' : '' }}" href="{{ route('front.blog') }}">Blogs</a></li>
                    <li><a class="nav-link scrollto {{ Request::is('jobs') ? 'active' : '' }}" href="{{ route('front.jobs') }}">Jobs</a></li>
