            ...
            <div class="row">
                <div class="row">
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/1.png') }}"
                            ...
                            <p>Protect your business from unauthorized access with robust network security measures, including firewalls, intrusion detection systems, and secure VPNs.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/2.png') }}"
                                alt="..." width="80px" style="padding: 8px; display: block; margin: 0 auto;">
                            <h3 style="text-align:center; margin-bottom: 10px;">Cloud Security
                            </h3>
                            <p>Secure your data and applications in the cloud. We ensure that your cloud infrastructure is safe, scalable, and compliant with industry standards.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/3.png') }}"
                                alt="..." width="80px" style="padding: 8px; display: block; margin: 0 auto;">
                            <h3 style="text-align:center; margin-bottom: 10px;">Endpoint Security
                            </h3>
                            <p>Safeguard all your devices, from desktops to mobile devices, with advanced endpoint protection that ensures no device goes unprotected.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/4.png') }}"
                                alt="..." width="80px" style="padding: 8px; display: block; margin: 0 auto;">
                            <h3 style="text-align:center; margin-bottom: 10px;">Incident Response & Recovery
                            </h3>
                            <p>In the event of a cyber attack or data breach, we provide immediate support to minimize damage and quickly restore your systems to full functionality.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/5.png') }}"
                                alt="..." width="80px" style="padding: 8px; display: block; margin: 0 auto;">
                            <h3 style="text-align:center; margin-bottom: 10px;">Data Encryption & Protection
                            </h3>
                            <p>We use advanced encryption techniques to secure your sensitive information, ensuring that it is protected from data breaches and unauthorized access.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex" data-aos="fade-up">
                        <div class="info-boxs">
                            <img src="{{ asset('front-assets/img/cyberlogo/6.png') }}"
                                alt="..." width="80px" style="padding: 8px; display: block; margin: 0 auto;">
                            <h3 style="text-align:center; margin-bottom: 10px;">Compliance & Regulatory Solutions
                            </h3>
                            <p>We help you stay compliant with various regulations such as GDPR, PCI-DSS, and HIPAA by providing tailored security solutions that align with industry standards.
                            </p>
                        </div>
                    </div>
                </div>
